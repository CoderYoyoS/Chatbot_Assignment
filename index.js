...
function getLibraryInfo(recipientId, action){
	...
	if(action == 'library-pin-not-enrolled'){
		options = {
			url: "https://daireapi.herokuapp.com/library/pin/notenrolled", 
			method : "GET"
		}
	}
	//User wants link to recover pin
		...
		options = {
			url: "https://daireapi.herokuapp.com/library/pin/recovery", 
			method : "GET"
		}
	}
	...
	//User clicked on online account
		...
		options = {
			url: "https://daireapi.herokuapp.com/library/account", 
			method : "GET"
		}
	}
	...
	//user wants link to check balance
		...
		options = {
			url: "https://daireapi.herokuapp.com/library/printcredit", 
			method : "GET"
		}
	}
	//User want's to know how to locate a book
		...
		options = {
			url: "https://daireapi.herokuapp.com/library/bookfind", 
			method : "GET"
		}
	}
	//User wants to know how to borrow a laptop
		...
		options = {
			url: "https://daireapi.herokuapp.com/library/laptop", 
			method : "GET"
		}
	}
